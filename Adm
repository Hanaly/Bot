...
function callback(e) {
    ...
    for (var i in r) {
        ...
        chatUtilities: {
            ...
            spam: [
                'fuckadmins', 'vaisefoder', 'lixo', 'retardado', 'ashole', 'fuck', 'idiota', 'babaca', 
                'fodasse', 'merda', 'pqp', 'puta', 'retarda', 'caralho', 'ppk',
                , 'fuder', 'foder', 'modafuka', 'modafoka', 'mudafuka', 'mudafoka', 'foda-se'
            ],
            curses: [
